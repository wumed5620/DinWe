...
export default function getSetUrl() {
					...
					<div className="row m-0 m-auto border rounded p-5 justify-content-center border-info col-12 col-md-8 col-lg-6" >
						<ul className="nav nav-tabs d-flex justify-content-around" id="myTab" role="tablist">
							<li className="nav-item" role="presentation">
								<button className="nav-link px-5 fs-4 active" id="registerform" data-bs-toggle="tab" data-bs-target="#registerform-pane" type="button">忘記密碼</button>
							</li>
						</ul>
						<div className="tab-content container row m-0" id="myTabContent">
							<div className="tab-pane fade show active" id="registerform-pane" role="tabpanel" aria-labelledby="registerform" tabIndex="0">
								<form onSubmit={handleRegister} method="post">
									...
									<div className="mb-3">
										<label htmlFor="member_account" className="form-label fs-5">填入信箱</label>
										<input value={reset.member_account} onChange={handleResetChange} type="phone" className="form-control" id="member_account" name="member_account" placeholder="請輸入電話號碼" maxLength="10"/>
									</div>
